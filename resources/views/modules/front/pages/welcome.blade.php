...
<header>
    ...
    <section class="tests">
            ...
            <div class="float-left rectangle-image">
                ...
                <div class="row all-tests">
                    <div class="col-md-6 col-lg-6">
                        <img class="img-responsive" src="{{asset('modules/front/assets/img/header/book1.png')}}" alt="book1">
                        <p>Мектеп» республикалық <br>
                            ғылыми-әдістемелік,<br>
                            педагогикалық журнал</p>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <img class="img-responsive" src="{{asset('modules/front/assets/img/header/book2.png')}}" alt="book2">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <img class="img-responsive" src="{{asset('modules/front/assets/img/header/book3.png')}}" alt="book3">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <img class="img-responsive" src="{{asset('modules/front/assets/img/header/book4.png')}}" alt="book4">
                        <p>«Қазығұрт.kz» <br>
                            әдеби-көркем, <br>
        ...
        <div class="float-right woman-img">
            <img class="img-responsive" src="{{asset('modules/front/assets/img/header/woman-image.png')}}" alt="Woman Image">
        </div>
                    ...
                    <div class="col-md-7 col-lg-7">
                        <div class="text-left">
                            ...
                            <p>
                                ...
                                ОМЖ, ҰМЖ, тәрбие сағаттары мен мұғалімдер мен оқушылардың ғылыми және шығармашылық жұмыстарын, іс-тәжірибеңізді жариялауға болады.
