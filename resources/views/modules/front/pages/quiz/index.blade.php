                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-7 col-lg-8 p-1 pr-3 d-block mt-1">
                                        ...
                                        <div class="d-block d-lg-flex">
                                            ...
                                            <a href="{{route('quiz.single' ,['id'=> $quiz->id])}}" class="btn btn-primary ml-auto float-right">Тапсырыс беру</a>
                                        </div>
                                        <a href="{{route('quiz.single' ,['id'=> $quiz->id])}}" class="stretched-link"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
