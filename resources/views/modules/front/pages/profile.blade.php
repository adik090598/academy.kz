            ...
            <div class="col-12 col-md-8 text-left">
                <div class="user_edit ">
                            <form action="{{route('user.update')}}" method="post" enctype="multipart/form-data">
                                <input type="file" name="avatar_path" value="null">
